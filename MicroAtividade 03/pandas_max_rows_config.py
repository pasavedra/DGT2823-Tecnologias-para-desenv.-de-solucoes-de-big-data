...
# 2. Configurar o número máximo de linhas para 9999
pd.set_option('display.max_rows', 9999)

print("Configuração aplicada: display.max_rows = 9999")
print("=" * 50)

# 3. Salvar as alterações (as opções são aplicadas automaticamente)
# As configurações do pandas são mantidas durante a sessão

# 4. Imprimir o conjunto de dados usando to_string()
print("Conjunto de dados completo:")
print(df.to_string())

print("\n" + "=" * 50)
print(f"Total de linhas no dataset: {len(df)}")
print("Todas as linhas foram exibidas devido à configuração max_rows = 9999")